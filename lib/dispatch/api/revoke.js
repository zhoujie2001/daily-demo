...
import { LarkApiError, LarkClient } from '../../lark/client.js';
...
export function createDispatchRevokeHandler({
  clientImpl = client,
} = {}) {
  return async function handler(req, res) {
    ...
    try {
      ...
      for (const messageId of messageIds) {
        await clientImpl.deleteMessage(messageId);
...
export default createDispatchRevokeHandler();
